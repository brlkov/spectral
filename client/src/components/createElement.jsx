...
const CreateElement = () => {
    ...
    const createNew = async () => {
        ...
        await axios.post("http://95.163.233.132:4000/api/create", formData).then(res => setMax(res.data))
    ...
    const saveNew = async () => {
        ...
        formData.append('file', file)
        await axios.post("http://95.163.233.132:4000/api/save", formData).then(res => document.location.reload())
    }
    ...
    return (
        <div className="newElement">
            ...
            <div className="newElementHeader">
                <p>Добавить новое вещество:</p>
            </div>
