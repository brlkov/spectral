        ...
        <div>
            <Header
                ...
                info={[
                    ...
                    "Занесите простые вещества в базу с помощью соотвествующей формы, после чего загрузите таблицу с результатами исследования сложного вещества и получите концетрацию (при наличии) в нем внесенных простых веществ.",
